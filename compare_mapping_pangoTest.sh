...
# Small Circuits（< 500KB） - 9个文件：
# design_13.aig (26K) - 最小
# design_18.aig (74K)
# design_14.aig (114K)
# design_19.aig (119K)
# design_9.aig (125K)
...
# design_17.aig (326K)
# 
# Medium Circuits（500KB - 5MB） - 5个文件：
# design_20.aig (756K)
# design_301.aig (954K)
# design_2.aig (1.3M)
# design_3.aig (1.6M)
...
# design_230.aig (17M)
# design_210.aig (18M)
# design_205.aig (19M) - 最大

set -e

YOSYS="./yosys"
ABC="./yosys-abc"
TEST_DIR="test_output_pango3"
...
# Test Groups
echo "================================================"
echo "  Test Group 1: Small Circuits (< 500KB)"
echo "================================================"
echo ""
...
for test_file in "${SMALL_TESTS[@]}"; do
    aig_path="tests/pango/$test_file"
    if [ -f "$aig_path" ]; then
...
echo ""
echo "================================================"
echo "  Test Group 2: Medium Circuits (500KB - 5MB)"
echo "================================================"
echo ""
...
# echo ""
# echo "================================================"
# echo "  Test Group 3: Large Circuits (> 5MB)"
# echo "================================================"
# echo ""
