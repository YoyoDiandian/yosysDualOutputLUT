#!/bin/bash
# Convert ISCAS85 BLIFs to AIG (optional) and run ABC vs LUT6D mapping,
...
YOSYS="./yosys"
ABC="./yosys-abc"
BLIF_DIR="/Users/yoyowang/Documents/Work/FudanCAD/paper2026/datasets/iscas85"
TEST_DIR="test_output_iscas85"
...
if [ ! -s "$LIST_FILE" ]; then
    echo -e "${RED}No ISCAS85 test cases found in $BLIF_DIR${NC}"
    exit 1
fi
